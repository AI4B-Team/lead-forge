...
export const Route = createFileRoute("/_authenticated/platform/sources")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Adapter roadmap ordered by real workspace demand for requested data sources." },
    ],
  }),
    ...
    <div className="mx-auto max-w-[1400px]">
          ...
          <Card>
            ...
            <CardContent className="overflow-x-auto">
              {demandQ.isLoading ? (
                ...
                <div className="py-8 text-center text-sm text-muted-foreground">No Source Requests Yet.</div>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
          ...
          <Dialog open={Boolean(openKey)} onOpenChange={(o) => !o && setOpenKey(null)}>
            <DialogContent className="max-h-[80vh] overflow-y-auto sm:max-w-xl">
              <DialogHeader><DialogTitle>Notify When Live</DialogTitle></DialogHeader>
